...
public class RenderWings extends ModelBase
{
    ...
    public RenderWings(WingSettings settings)
    {
        ...
        this.location = new ResourceLocation("wingsmod", "wings.png"); // Set the ResourceLocation instance with the path to the wings texture.
        ...
        wing.setTextureSize(30, 30); // Set the size of the texture for the wing.
        wing.setRotationPoint(-2F, 0, 0); // Set the rotation point for the wing.
        wing.addBox("bone", -10.0F, -1.0F, -1.0F, 10, 2, 2); // Add a box to the wing model to represent the bone.
